...
from lib.std.types.generator_types import BlockGenerator, GeneratorArg, GeneratorBlockCacheInterface, CompressorArg
from lib.std.types.ints import uint32, uint64
from lib.std.util.load_clvm import load_clvm
from lib.std.spends.rom_bootstrap_generator import get_generator

GENERATOR_MOD = get_generator()

DECOMPRESS_BLOCK = load_clvm("./lib/std/clvm/block_program_zero.clvm")
DECOMPRESS_PUZZLE = load_clvm("./lib/std/clvm/decompress_puzzle.clvm")
# DECOMPRESS_CSE = load_clvm("decompress_coin_solution_entry.clvm", package_or_requirement="chia.wallet.puzzles")

DECOMPRESS_CSE_WITH_PREFIX = load_clvm("./lib/std/clvm/decompress_coin_solution_entry_with_prefix.clvm")
