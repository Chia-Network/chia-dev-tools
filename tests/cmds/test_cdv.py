...
class TestCdvCommands:
    def test_encode_decode(self):
        runner = CliRunner()
        puzhash: str = (
            "3d4237d9383a7b6e60d1bfe551139ec2d6e5468205bf179ed381e66bed7b9788"
        )
        ...
        test_address: str = (
            "txch184pr0kfc8fakucx3hlj4zyu7cttw235zqkl308kns8nxhmtmj7yqth5tat"
        )
        assert result.exit_code == 0
    ...
    def test_hash(self):
        ...
        assert result.exit_code == 0
        assert (
            "8f6e594e007ca1a1676ef64469c58f7ece8cddc9deae0faf66fbce2466519ebd"
            in result.output
        )
    ...
    def test_test(self):
        ...
        with runner.isolated_filesystem():
            ...
            assert result.exit_code == 0
            assert (
                Path("./tests").exists() and Path("./tests/test_skeleton.py").exists()
            )
